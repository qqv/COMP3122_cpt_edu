                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <Box
                              sx={{
                                ...
                                borderRadius: 1,
                                fontSize: '0.75rem',
                                bgcolor: student.status === 'Active' ? 'success.100' : 
                                         student.status === 'Warning' ? 'warning.100' : 'error.100',
                                color: student.status === 'Active' ? 'success.700' : 
                                       student.status === 'Warning' ? 'warning.700' : 'error.700',
                              }}
                            >
                              {student.status}
                            </Box>
                                  ...
                                  sx={{
                                    ...
                                    '& .MuiLinearProgress-bar': {
                                      bgcolor: student.progress > 75 ? 'success.main' :
                                              student.progress > 50 ? 'primary.main' :
                                              student.progress > 25 ? 'warning.main' : 'error.main'
                                    }
                                  }}
                                />
                              </Box>
